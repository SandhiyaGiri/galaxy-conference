...
const LEVERS = [
  {
    id: 1, icon: <ToggleRight size={48} />, title: "Payment Modernization",
  ...
  {
    id: 2, icon: <ToggleRight size={48} />, title: "Tokenized Deposits",
  ...
  {
    id: 3, icon: <ToggleRight size={48} />, title: "Digital Experiences",
  ...
  },
  {
    ...
    blocks: ["trade"],
    description: "EXIM STAR from Trade Galaxy let you offer letters of credit, bank guarantees — revenue streams previously only available to large banks.",
  ...
  {
    id: 7, icon: <ToggleRight size={48} />, title: "Embedded Banking",
  ...
  {
    id: 8, icon: <ToggleRight size={48} />, title: "Specialty Deposits",
  ...
  {
    id: 9, icon: <ToggleRight size={48} />, title: "Partner Banking",
